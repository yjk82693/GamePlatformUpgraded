...
export default function TopupPage() {
  ...
  if (loading) return <p style={{ color: tokens.color.textMuted, padding: 24 }}>Loading topup center...</p>
  ...
  return (
    <div style={{ padding: 24 }}>
      <h1 style={{ fontFamily: tokens.font.display, fontSize: 20, marginBottom: 24 }}>Topup Center</h1>
      ...
      {products.length === 0 && (
        <p style={{ color: tokens.color.textMuted }}>
          No items available yet — add a game to your library from the Store first.
        </p>
      )}
